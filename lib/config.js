...
const NOTIFICATION_EVENT_TYPES = [
  ...
  { key: 'driver_missed_ride', label: 'Driver Missed Assigned Ride', description: 'A scheduled ride passes its requested time without the assigned driver starting it', defaultThreshold: 15, thresholdUnit: 'minutes', category: 'rides' },
